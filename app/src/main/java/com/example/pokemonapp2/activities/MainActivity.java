...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pokemonViewModel.getLiveList().observe(this, new Observer<List<Pokemon>>() {
            @Override
            public void onChanged(List<Pokemon> pokemons) {
                adapter.setPokemonList(pokemons);
            }
        });
        findViewById(R.id.btn_to_fav).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void swipe(){
        ItemTouchHelper.SimpleCallback simpleCallback = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.RIGHT) {
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                pokemonViewModel.insertPokemon(pokemonAt);
                adapter.notifyDataSetChanged();
                Toast.makeText(MainActivity.this, "inserted done ", Toast.LENGTH_SHORT).show();
